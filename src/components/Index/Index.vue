          ...
          <div class="row">
            ...
            <div class="col-sm-offset-2 col-md-offset-5 col-sm-6 col-md-4 hidden-xs">
              ...
              <div class="col-xs-6 col-sm-7">
                <div class="exchange">
                  <p class="exchange__name"><span style="color:#ffffff">Central Bank Rate</span></p>
                  <p class="exchange__course">
                    <span style="color:#ffffff">$ 32.32</span><span style="color:#ffffff">&#8364; 28.23</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="wrapper clearfix bigmegamenu">
            ...
            <nav class="wsmenu slideLeft clearfix">
              <ul class="mobile-sub wsmenu-list">
                ...
                <li>
                  <span class="wsmenu-click"></span>
                  <a href="category.html"><span style="color:#746e71;">Policy</span></a>
                </li>
                <li>
                  <span class="wsmenu-click"></span>
                  <a href="category.html"><span style="color:#746e71;">Sport</span></a>
                </li>
                <li>
                  <span class="wsmenu-click"></span>
                  <a href="category.html"><span style="color:#746e71;">Holidays</span></a>
                </li>
                <li>
                  <span class="wsmenu-click"></span>
                  <a href="category.html"><span style="color:#746e71;">Religion</span></a>
                </li>
                <li>
                  <span class="wsmenu-click"></span>
                  <a href="category.html"><span style="color:#746e71;">People</span></a>
                </li>
                <li>
                  <span class="wsmenu-click"></span>
                  <a href="category.html"><span style="color:#746e71;">Main</span></a>
                </li>
                <li>
                  <span class="wsmenu-click"></span>
                  <a href="">Other
                  ...
                  <div class="visible-xs col-sm-offset-5 col-sm-4">
                    <div class="col-sm-5">
                      <div class="weather">
                        <div class="weather__temperature">
                          <span class="icon-sun"></span>
                          <em> <span style="color:#ffffff;">+8 C</span></em>
                        </div>
                        <div class="weather__city">
                          <em>London</em>
                          <div class="weather__city__list">
